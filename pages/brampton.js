      ...
      >
        ...
        >
          <Image
            ...
            onMouseEnter={(e) => {
              e.target.style.transform = "rotate(75deg) scale(0.6)";
              e.target.style.transition = "all 0.3s ease";
            }}
            onMouseLeave={(e) => {
              e.target.style.transform = "rotate(45deg) scale(1.0)";
            }}
            src="/city/brampton/samosa.png"
            alt="Blue paper star"
          />
          <Image
            sx={{
            ...
            onMouseEnter={(e) => {
              e.target.style.transform = "rotate(60deg) scale(0.7)";
              e.target.style.transition = "all 0.3s ease";
            }}
            onMouseLeave={(e) => {
              e.target.style.transform = "rotate(30deg) scale(1.1)";
            }}
            src="/city/brampton/samosa.png"
          ...
          <Image
            ...
            onMouseLeave={(e) => {
              e.target.style.transform = "rotate(-20deg) scale(1.5)";
            }}
            src="/city/brampton/samosa.png"
            alt="Pink paper star"
          />
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {/* TODO: Change Brampton to your event's city */}
              Scrapyard Brampton is a hackathon for high schoolers
              {/* TODO: Change Brampton to your event's city */}
              happening in Brampton, where you can make the stupidest
              ...
              {/* TODO: Change Brampton to your event's city */}
              Brampton needs you and your scrappy ideas!
            </p>
          </Box>
        </Box>
        <Box
...
//         >
//           {/* TODO: Change Brampton to your event's city */}
//           WHAT'S HAPPENING AT SCRAPYARD Brampton?
//         </Heading>
//       </Box>
//       <Heading
//         as="h2"
...
//         Scrapyard Brampton is a [DURATION] event - HERE'S THE ROUGH
//         SCHEDULE!
//       </Heading>
//       <Box
//         sx={{
          ...
          {Object.entries({
            ...
            'What if my parents are concerned?': (
              <>
                ...
                <Link href="mailto:scrapyard.brampton@gmail.com">
                  {/* TODO: Change this email to your event's email */}
                  scrapyard.brampton@gmail.com
                </Link>{' '}
                for questions.
              </>
            ),
            'What if I have more questions?': (
              <>
                ...
                Contact us! Feel free to reach out to us in the <Link href="https://hackclub.slack.com/archives/C08ALRLGJFP">slack channel</Link>{" "}
        ...
        </Grid>
  {
        ...
        >
          ...
          >
            ...
            >
              {/* TODO: Change Brampton to your event's city */}
              SIGN UP FOR SCRAPYARD Brampton
            </Heading>
          </Box>
        </Link>
        <Heading

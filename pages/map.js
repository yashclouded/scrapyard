    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Build stupid projects, get stupid prizes.
            </Heading>
          </Box>
          <Box
            sx={{
          ...
          >
            ...
            >
              100+&nbsp;Cities&nbsp;worldwide&nbsp;March&nbsp;13-14
            </Heading>
            <Heading
              as="h2"
              sx={{
        ...
        <Box
          as="a"
          href="https://forms.hackclub.com/t/eWz6Un4TLUus"
          sx={{
            backgroundImage: "url('/elements/yellow-strip@stretch.svg')",
            backgroundRepeat: 'no-repeat',
            backgroundSize: '100% 100%',
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Scrapyard is a global hackathon by high schoolers running in Los
              Angeles and over 100+ other cities, with a "scrappy" theme of
              stupid projects! It's organized by Hack Club, a 501c(3) nonprofit
              that supports a global community of over 48,000 high school
              makers.
            </p>
          </Box>
        </Box>
      ...
      >
        ...
        <Grid columns={[1, 1, 2]} gap={4}>
          {Object.entries({
            'What is scrapyard?':
              'Scrapyard is a hackathon for high school students, organized by the students of the BRT High School.',
            'When is Scrapyard?':
              'Scrapyard will be held on February 15-16, 2024.',
            'Where is Scrapyard?':
              'Scrapyard will be held at the BRT High School.',
            'How can I participate?':
              'Participation details will be announced soon.'
          }).map(([question, answer], i) => {
            return (
              <Card
                sx={{
                  background: `url('/elements/doodles/boxes/${
                    (i % 6) + 1
                  }.svg')`,
                  backgroundSize: '100% 100%',
                  backgroundRepeat: 'no-repeat',

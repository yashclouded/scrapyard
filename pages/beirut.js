...
export default function ExampleCity() {
  return (
    ...
    >
      <Head>
        {/* TODO: Change Beirut to your event's city */}
        <title>Scrapyard Beirut</title>
      </Head>
      <Flag />
      <Box
        sx={{
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {/* TODO: Change Beirut to your event's city */}
              Scrapyard Beirut is a hackathon for high schoolers
              {/* TODO: Change Beirut to your event's city */}
              happening in Beirut, where you can make the stupidest
              ...
              {/* TODO: Change Beirut to your event's city */}
              Beirut needs you and your scrappy ideas!
            </p>
          </Box>
        </Box>
        <Box
      ...
      >
        ...
        >
          ...
          >
            {/* TODO: Change Beirut to your event's city */}
            WHAT'S HAPPENING AT SCRAPYARD BEIRUT?
          </Heading>
        </Box>
        <Heading
          as="h2"
        ...
        >
          ...
          Scrapyard Beirut is a 12hour event - HERE'S THE ROUGH
          SCHEDULE!
        </Heading>
        <Box
          sx={{
          ...
          {Object.entries({
            ...
            'What if my parents are concerned?': (
              <>
                ...
                they can reach out to us at{'beirut.scrapyard@hackclub.com'}
                {/* TODO: Change this email to your event's email */}
                <Link href="mailto:beirut.scrapyard@hackclub.com">
                  {/* TODO: Change this email to your event's email */}
                  beirut.scrapyard@hackclub.com
                </Link>{' '}
                for questions.
              </>
            ),
            'What if I have more questions?': (
              <>
                ...
                Contact us! Feel free to reach out to us in the #scrapyard-beirut

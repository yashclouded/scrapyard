...
export default function ExampleCity() {
  return (
    ...
    >
      <Head>
        {/* TODO: Change NoVA to your event's city */}
      ...
      >
        ...
        >
          <Image
            ...
            src="https://cloud-7eb83b8ac-hack-club-bot.vercel.app/0scrapyardnovalogo.svg"
            alt="Scrapyard"
          />
        </Box>
        <Box
        ...
        >
          ...
          >
            ...
            >
              {/* TODO: Change NoVA to your event's city */}
              Grounds Central Station - March&nbsp;15-16
            </Heading>
          </Box>
        </Box>
        <Box
        ...
        <Link
          // TODO: Change nova to your event's slug (lowercase, dashed version of your event name), such as san-francisco for Scrapyard San Francisco
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {/* TODO: Change NoVA to your event's city */}
              Scrapyard NoVA is a hackathon for high schoolers
              {/* TODO: Change NoVA to your event's city */}
              happening in NoVA, where you can make the stupidest
              ...
              {/* TODO: Change NoVA to your event's city */}
              NoVA needs you and your scrappy ideas!
            </p>
          </Box>
        </Box>
        <Box
      ...
      >
        ...
        >
          ...
          Scrapyard NoVA is a 24 hour event - HERE'S THE ROUGH
          SCHEDULE!
        </Heading>
        <Box
          sx={{
          ...
          {Object.entries({
            ...
            'What if my parents are concerned?': (
              <>
                ...
                <Link href="mailto:shayaand.brambleton@scrapyard.hackclub.com">
                  {/* TODO: Change this email to your event's email */}
                  shayaand.brambleton@scrapyard.hackclub.com
                </Link>{' '}
                for questions.
              </>
            ),

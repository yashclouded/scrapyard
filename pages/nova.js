...
export default function NoVA() {
			...
			try {
				...
				let data = responseJSON['schedule'].map(e => {
					try {
						...
						return {
							time: `${date.getHours()}:${String(date.getMinutes()).padStart(2, '0')}`, // Formats minutes with a leading 0
	...
	return (
		...
		>
			...
			{/* TODO: Create Sponsors Section (like in Scrapyard Silicon Valley) >:) */}
			<Box></Box>
			<Box
				sx={{
					width: '100%',

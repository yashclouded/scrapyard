...
const schedule = [
  { time: '9:30AM', event: 'Doors open' },
  { time: '10 AM', event: 'Opening ceremony' },
  { time: '11 AM', event: 'Workshop 1' },
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Link
          href="https://forms.hackclub.com/scrapyard-signup?event=dudley"
          target="_blank"
        >
          <Box
            sx={{
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Scrapyard Dudley is a hackathon for high schoolers
              happening in Dudley, where you can make the stupidest
              ...
              Dudley needs you and your scrappy ideas!
            </p>
          </Box>
        </Box>
        <Box
      ...
      >
        ...
        >
          ...
          >
            WHAT'S HAPPENING AT SCRAPYARD DUDLEY?
          </Heading>
        </Box>
        <Heading
          as="h2"
        ...
        >
          Scrapyard DUDLEY is a 12 hour event - HERE'S THE ROUGH
          SCHEDULE!
        </Heading>
        <Box
          sx={{
          ...
          {Object.entries({
            ...
            'What if my parents are concerned?': (
              <>
                ...
                <Link href="mailto:dudley@scrapyard.hackclub.com">
                  dudley@scrapyard.hackclub.com
                </Link>{' '}
                for questions.
              </>
            ),
            'What if I have more questions?': (
              <>
                Contact us! Feel free to reach out to us in the #scrapyard-dudley

...
const schedule = [
  ...
  { time: '10:00 AM', event: 'Cerimônia de abertura' },
  { time: '10:30 AM', event: 'Atividade 1' },
  { time: '11:30 AM', event: 'Start working on your project!' },
  { time: '1:00 PM', event: 'Almoço' },
  { time: '2:00 PM', event: 'Workshop 1' },
  { time: '4:00 PM', event: 'Workshop 2' },
  { time: '7:00 PM', event: 'Demos' },
  { time: '8:00 PM', event: 'Cerimônia de Encerramento' }
]
  ...
  return (
    ...
    >
      <Head>
        ...
        <title>Scrapyard São Paulo</title>
      </Head>
      <Flag />
      <Box
        sx={{
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Construa coisas inúteis, ganhe prêmios inúteis.
            </Heading>
          </Box>
          <Box
            sx={{
        ...
        <Link
          ...
          href="https://forms.hackclub.com/scrapyard-signup?event=sao-paulo"
          target="_blank"
        >
          <Box
            sx={{
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {/* TODO: Change [EXAMPLECITY] to your event's city */}
              Scrapyard São Paulo é um hackathon para estudantes de ensino médio
              {/* TODO: Change [EXAMPLECITY] to your event's city */}
              acontecendo em São Paulo, onde você pode fazer as coisas mais estúpidas 
              que você pode pensar! Qualquer coisa, de um{' '}
              <Link href="https://www.youtube.com/watch?v=PnK4gzO6S3Q">
                lâmpada que pisca mais rápido quanto mais devagar você digita
              </Link>
              , para aquelas ideias que você não ousaria considerar úteis, 
              vai para o Scrapyard. Não importa sua experiência, o Scrapyard
              {/* TODO: Change [EXAMPLECITY] to your event's city */}
              São Paulo precisa de você e de suas ideias inovadoras!
            </p>
          </Box>
        </Box>
        <Box
      ...
      >
        ...
        >
          ...
          >
            {/* TODO: Change [EXAMPLECITY] to your event's city */}
            O QUE ESTÁ ACONTECENDO NO SCRAPYARD SÃO PAULO?
          </Heading>
        </Box>
        <Heading
          as="h2"
        ...
        >
          ...
          Scrapyard São Paulo é um evento 12 horas - AQUI ESTÁ A PROGRAMAÇÃO 
          PREVISTA!
        </Heading>
        <Box
          sx={{
      ...
      >
        ...
        >
          ...
          >
            {/* TODO: Change [EXAMPLECITY] to your event's city */}
            NÃO CONSEGUE CHEGAR EM SÃO PAULO [EXAMPLECITY]?
          </Heading>
        </Box>
        <Heading
          as="h2"
        ...
        >
          HÁ MAIS DE 100 OUTROS EVENTOS DE SCRAPYARD ACONTECENDO AO REDOR DO MUNDO!
        </Heading>
        <Box
          sx={{
            width: ['100%', '80%'],
      ...
      >
        ...
        >
          {Object.entries({
            'Sou eligível para participar?': (
              <>
                Se você tem 18 anos ou menos, sim, nós estamos anciosos para te conhecer! 
                Se você tem mais de 18 mas ainda no ensino médio, nos envie um email.
              </>
            ),
            'Quanto custa para participar?': (
              <>
                É completamente de graça! Teremos refeições, snacks e bebidas (não alcoólicas!) 
                no hackathon, como também brindes, prêmios e mini-eventos divertidos.
              </>
            ),
            'O que devo levar?': (
              <>
                Seu laptop, carregador, e uma mente aberta!
              </>
            ),
            'Eu não sou bom programando, posso participar?': (
              <>
                Esse hackathon é para hackers (hackers do bem!) de todos níveis de 
                habilidade! Nós vamos ter workshops e outros eventos para unir-mos
                 e aprender juntos. Se você gostaria de começar explorando alguns 
                 projetos introdutórios, check Hack Club Workshops.
              </>
            ),
            'O que posso fazer no Scrapyard?': (
              <>
                A coisa mais desleixada que você pode imaginar – tranqueiras é encorajado.
                Jogos? Apps? Websites? Linguagens de Programação? <em>Hardware?</em>{' '}
                Você escolhe! Teremos um monte de recursos (em caso de Hardware, procure trazer próprio) 
                e mentores para ajudar você.
              </>
            ),
            'O que Hack Club já fez no passado?': (
              <>
                O Hack Club realizou um{' '}
                ...
                em 50 cidades, um hackathon em um{' '}
                <Link href="https://youtu.be/2BID8_pGuqA" target="_blank">
                  Trem
                </Link>{' '}
                de Vermont para Los Angeles, e muito mais!
              </>
            ),
            'Meus pais estão preocupados!': (
              <>
                Estamos aqui para ajudar! Peça para eles mandarem um email para{' '}
                {/* TODO: Change this email to your event's email */}
                <Link href="mailto:sao-paulo@scrapyard.hackclub.com">
                  {/* TODO: Change this email to your event's email */}
                  sao-paulo@scrapyard.hackclub.com
                </Link>{' '}
                .
              </>
            ),
            'Tenho mais perguntas!': (
              <>
                ...
                Contacte-nos! Mande um email para{' '}
                {/* TODO: Change this email to your event's email */}
                <Link href="mailto:sao-paulo@scrapyard.hackclub.com">
                  {/* TODO: Change this email to your event's email */}
                  sao-paulo@scrapyard.hackclub.com
        ...
        >
          ...
          >
            ...
            >
              {/* TODO: Change [EXAMPLECITY] to your event's city */}
              REGISTRE-SE PARA SCRAPYARD SÃO PAULO
            </Heading>
          </Box>
        </Link>
        <Heading
        ...
        >
          Feito por adolescentes, para adolescentes no Hack Club
        </Text>
        <Text
          sx={{
            fontFamily: 'moonblossom',

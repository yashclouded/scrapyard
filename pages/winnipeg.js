...
export default function ExampleCity() {
  ...
  return (
    ...
    >
      <Head>
        <title>Scrapyard Winnipeg</title>
      </Head>
      <Flag />
      <Box
        sx={{
      ...
      >
        ...
        >
          <Image
            ...
            src="/city/winnipeg/SY_winnipeg_logo.png"
            alt="Scrapyard"
          />
        </Box>
        <Box
        ...
        >
          ...
          >
            ...
            >
              ...
              Winnipeg needs you and your scrappy ideas!
            </p>
          </Box>
        </Box>
        <Box
...
<Box
      ...
      >
        ...
        >
          ...
          >
            WHAT'S HAPPENING AT SCRAPYARD WINNIPEG?
          </Heading>
        </Box>
        <Heading
          as="h2"
        ...
        >
          Scrapyard Winnipeg is a 12 hour event - HERE'S THE ROUGH
          SCHEDULE!
        </Heading>
        <Box
          sx={{
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              SIGN UP FOR SCRAPYARD WINNIPEG
            </Heading>
          </Box>
        </Link>
        <Heading

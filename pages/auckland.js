...
const schedule = [
  ...
  { time: '9:30 PM', event: 'Start working on your project!' },
  ...
  return (
    ...
    >
      <Head>
        ...
        <title>Scrapyard Auckland</title>
      </Head>
      <Flag />
      <Box
        sx={{
      ...
      >
        ...
        <Link
          ...
          href="https://forms.hackclub.com/scrapyard-signup?event=auckland"
          target="_blank"
        >
          <Box
            sx={{
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {/* TODO: Change [EXAMPLECITY] to your event's city */}
              Scrapyard Auckland is a hackathon for high schoolers
              {/* TODO: Change [EXAMPLECITY] to your event's city */}
              happening in Auckland, New Zealand, where you can make the stupidest
      ...
      >
        ...
        >
          ...
          >
            {/* TODO: Change [EXAMPLECITY] to your event's city */}
            WHAT'S HAPPENING AT SCRAPYARD AUCKLAND?
          </Heading>
        </Box>
        <Heading
          as="h2"
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {/* TODO: Change [EXAMPLECITY] to your event's city */}
              SIGN UP FOR SCRAPYARD AUCKLAND
            </Heading>
          </Box>
        </Link>
        <Heading

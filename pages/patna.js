    ...
    >
      ...
      >
        ...
        >
         ...
         {/* Image Section */}
         <img
  src="/city/patna/Come and join us to Meet some cool People Like them (1).png"
      ...
      >
        ...
        <Box sx={{ textAlign: 'center', mt: 5 }}>
          ...
          <Link href="https://instagram.com/scrapyard_patna" target="_blank" sx={{ mx: 2 }}>
            <Image src="city/patna/icons/instagram.svg.svg" alt="Instagram" width={130} height={130} />
          </Link>
          <Link href="https://hackclub.slack.com/archives/C08AGCCLMJL" target="_blank" sx={{ mx: 2 }}>
            <Image src="city/patna/icons/Slack_Technologies_Logo.svg.svg" alt="Slack" width={130} height={130} />
          </Link>
          <Link href="https://forms.hackclub.com/scrapyard-signup?event=patna" target="_blank" sx={{ mx: 2 }}>
            <Image src="city/patna/icons/Screenshot 2025-02-21 040321.svg" alt="Sign Up" width={130} height={130} />
          </Link>
          <Link href="mailto:pulkitparmar09@gmail.com" sx={{ mx: 2 }}>
            <Image src="city/patna/icons/Gmail_icon_(2020).svg.svg" alt="Email" width={130} height={130} />
          </Link>
        </Box>
      </Box>
